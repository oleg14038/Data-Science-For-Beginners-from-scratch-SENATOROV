...
#
#     Через кнопку внизу
#         В нижней части редактора найдите вкладку "Problems" (значок 🚨 ошибки/предупреждения).
...
#
#
# Картинка из интернета: ![Логотип GitHub](https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png)
#
#
