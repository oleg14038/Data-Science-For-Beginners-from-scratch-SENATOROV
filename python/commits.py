...
#
# коммит feat - при этом коммите разробочик сообщает что добовляеет новый функционал  (изменения стиля)
#
# коммит fix - при обнуружение ошибки кода разрабочик исправляет ошибку и отправляет коммит это показывает что он исправил - git commit -m "fix: неисправность........."
#
...
#     Исправление ошибок в тестах (например, если тесты не прошли из-за изменений в коде).
...
#
#     Добавление, обновление или удаление зависимостей (например, в package.json или requirements.txt).
...
#
#     Изменение конфигурации для систем CI/CD (например, GitHub Actions, Jenkins, Travis CI).
...
#
# git commit -m "ci: добавлена конфигурация для автоматической сборки на GitHub Actions"
#
#
...
#     Использование более эффективных методов или библиотек для выполнения задач.
#
# chore – технические изменения, не влияющие на код (обновление конфигураций, линтеров).
#
# Когда использовать chore?
#
#     Обновление зависимостей, которые не влияют напрямую на код (например, обновление версий линтеров или тестовых библиотек).
#     Изменения в конфигурациях (например, настройка ESLint, Prettier, обновление конфигов для сборки).
